...
import { Menu, X, ChevronLeft, ChevronRight, ShoppingBag, Briefcase, Shield, ArrowRight, Heart, Facebook, Twitter, Instagram, Linkedin } from 'lucide-react';
import heroVideo from './assets/video.mp4';
import leatherBeltImg from './assets/leather.jpg';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50 text-[#113649] overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          {/* Premium Overlay with Subtle Gradient - Video Visible */}
          <div className="absolute inset-0 bg-gradient-to-b from-white/70 via-slate-50/60 to-white/75"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 z-10 py-40">
          <div className="max-w-6xl mx-auto text-center">
            {/* Premium Badge */}
            <div className="inline-flex items-center gap-2 mb-8 sm:mb-12 group cursor-pointer">
              <div className="h-px w-8 sm:w-12 bg-gradient-to-r from-transparent via-[#C9A026] to-[#C9A026] group-hover:w-12 sm:group-hover:w-16 transition-all duration-500"></div>
              <span className="text-[#C9A026] text-xs sm:text-sm font-bold tracking-[0.2em] sm:tracking-[0.3em] uppercase">Since 1995</span>
              <div className="h-px w-8 sm:w-12 bg-gradient-to-l from-transparent via-[#C9A026] to-[#C9A026] group-hover:w-12 sm:group-hover:w-16 transition-all duration-500"></div>
            </div>
            
            {/* Luxury Main Heading - FULLY RESPONSIVE */}
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl 2xl:text-[10rem] font-bold mb-8 sm:mb-12 leading-[0.9] sm:leading-[0.85] tracking-tighter px-4">
              <span className="block text-[#113649] mb-4 sm:mb-6 animate-fade-in">Luxury Leather</span>
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-[#113649]/70 max-w-4xl mx-auto mb-12 sm:mb-16 leading-relaxed font-light tracking-wide px-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-16 sm:mb-20 px-4">
              <button className="w-full sm:w-auto group relative overflow-hidden bg-gradient-to-r from-[#1E928C] via-[#1E928C] to-[#113649] text-white px-10 sm:px-12 py-5 sm:py-6 rounded-full font-bold text-base sm:text-lg shadow-2xl hover:shadow-[#1E928C]/60 transition-all duration-500 flex items-center justify-center gap-3 hover:scale-110 hover:-translate-y-1">
                <span className="relative z-10">Explore Collections</span>
                <ArrowRight className="w-5 h-5 sm:w-6 sm:h-6 group-hover:translate-x-2 transition-transform duration-500 relative z-10" />
                <div className="absolute inset-0 bg-gradient-to-r from-[#C9A026] to-[#1E928C] opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              </button>
              <button className="w-full sm:w-auto group relative border-2 border-[#C9A026] backdrop-blur-xl bg-white/60 text-[#113649] px-10 sm:px-12 py-5 sm:py-6 rounded-full font-bold text-base sm:text-lg hover:bg-white hover:border-[#1E928C] hover:text-[#1E928C] transition-all duration-500 hover:scale-110 hover:-translate-y-1 shadow-xl hover:shadow-2xl">
            ...
            {/* Premium Stats Mini Display - RESPONSIVE */}
            <div className="flex items-center justify-center gap-6 sm:gap-8 md:gap-12 text-center flex-wrap px-4">
              <div className="group cursor-pointer">
                <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-[#1E928C] to-[#C9A026] bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">40+</div>
                <div className="text-[#113649]/60 text-xs sm:text-sm uppercase tracking-wider mt-1">Years</div>
              </div>
              <div className="h-10 sm:h-12 w-px bg-gradient-to-b from-transparent via-[#1E928C] to-transparent"></div>
              <div className="group cursor-pointer">
                <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-[#1E928C] to-[#C9A026] bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">500+</div>
                <div className="text-[#113649]/60 text-xs sm:text-sm uppercase tracking-wider mt-1">Partners</div>
              </div>
              <div className="h-10 sm:h-12 w-px bg-gradient-to-b from-transparent via-[#C9A026] to-transparent"></div>
              <div className="group cursor-pointer">
                <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-[#1E928C] to-[#C9A026] bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">100K+</div>
                <div className="text-[#113649]/60 text-xs sm:text-sm uppercase tracking-wider mt-1">Products</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 bg-gradient-to-b from-white via-slate-50 to-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 lg:gap-12">
            {/* Premium Stat Card 1 */}
            <div className="group relative bg-white/80 backdrop-blur-2xl border-2 border-[#1E928C]/20 rounded-3xl p-8 sm:p-10 md:p-12 hover:border-[#1E928C] transition-all duration-500 hover:shadow-[0_20px_80px_rgba(30,146,140,0.3)] hover:-translate-y-3 hover:scale-105 cursor-pointer">
            ...
            {/* Premium Stat Card 2 */}
            <div className="group relative bg-white/80 backdrop-blur-2xl border-2 border-[#C9A026]/20 rounded-3xl p-8 sm:p-10 md:p-12 hover:border-[#C9A026] transition-all duration-500 hover:shadow-[0_20px_80px_rgba(201,160,38,0.3)] hover:-translate-y-3 hover:scale-105 cursor-pointer">
      ...
      <section className="py-20 relative bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 text-[#113649] px-4">
              Featured <span className="text-[#1E928C]">Collections</span>
            </h2>
            <p className="text-[#113649]/70 text-base sm:text-lg max-w-2xl mx-auto px-4">
      ...
      {/* About Section with Cards - RESPONSIVE */}
      <section id="about" className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-16 sm:mb-20">
            <div className="order-2 lg:order-1">
              <span className="text-[#C9A026] font-bold tracking-wider uppercase text-xs sm:text-sm">Leather Luxury</span>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mt-4 mb-6 text-[#113649]">
                Crafting Excellence Since 1995
              </h2>
              <p className="text-[#113649]/80 text-base sm:text-lg leading-relaxed mb-6">
              ...
              <p className="text-[#113649]/80 text-base sm:text-lg leading-relaxed">
            ...
            <div className="relative order-1 lg:order-2">
              ...
              <img 
                ...
                className="relative rounded-2xl shadow-2xl border-4 border-[#1E928C]/20 w-full"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {features.map((feature, idx) => (
              <div 
                key={idx}
                className="group bg-white p-6 sm:p-8 rounded-2xl border-2 border-[#1E928C]/30 hover:border-[#1E928C] transition-all hover:shadow-xl hover:shadow-[#1E928C]/20 hover:-translate-y-2"
              >
                <div className="bg-gradient-to-br from-[#1E928C] to-[#113649] w-14 h-14 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center mb-6 text-white group-hover:scale-110 transition-transform shadow-lg">
                  {feature.icon}
                </div>
                <h3 className="text-lg sm:text-xl font-bold mb-3 text-[#113649]">{feature.title}</h3>
                <p className="text-[#113649]/70 leading-relaxed text-sm sm:text-base">{feature.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { title: "Leather Belts", img: leatherBeltImg },
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12 sm:mb-20">
            <div className="inline-flex items-center gap-2 sm:gap-3 mb-6">
              <div className="h-px w-8 sm:w-16 bg-gradient-to-r from-transparent to-[#C9A026]"></div>
              <span className="inline-block bg-gradient-to-r from-[#1E928C] to-[#C9A026] text-white px-4 sm:px-8 py-2 sm:py-3 rounded-full text-[10px] sm:text-xs font-bold tracking-[0.2em] sm:tracking-[0.3em] uppercase shadow-xl">
                Got Questions?
              </span>
              <div className="h-px w-8 sm:w-16 bg-gradient-to-l from-transparent to-[#C9A026]"></div>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#113649] mb-6 tracking-tight px-4">
              Frequently Asked Questions
            </h2>
            <p className="text-[#113649]/60 text-base sm:text-lg md:text-xl max-w-3xl mx-auto leading-relaxed font-light px-4">
            ...
            {[
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between p-5 sm:p-6 md:p-8 text-left transition-all"
                >
                  <span className="text-base sm:text-lg md:text-xl font-bold text-[#113649] pr-4 sm:pr-8 group-hover:text-[#1E928C] transition-colors duration-300">
                    {faq.question}
                  </span>
                  <div className={`flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-[#1E928C] to-[#C9A026] flex items-center justify-center transition-all duration-500 shadow-lg group-hover:shadow-xl group-hover:scale-110 ${openFaq === idx ? 'rotate-180' : ''}`}>
                    <ChevronLeft className="w-5 h-5 sm:w-6 sm:h-6 text-white rotate-[-90deg]" />
                  </div>
                </button>
                ...
                <div className={`transition-all duration-500 ease-in-out ${openFaq === idx ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'} overflow-hidden`}>
                  <div className="px-5 sm:px-6 md:px-8 pb-5 sm:pb-6 md:pb-8 pt-0">
                    <div className="border-t-2 border-gradient-to-r from-[#1E928C]/20 to-[#C9A026]/20 pt-4 sm:pt-6">
                      <p className="text-[#113649]/70 leading-relaxed text-sm sm:text-base md:text-lg">
                        {faq.answer}
                      </p>
                    </div>
                  </div>
          ...
          {/* Premium Contact CTA - RESPONSIVE */}
          <div className="mt-12 sm:mt-16 text-center p-8 sm:p-10 md:p-12 bg-gradient-to-br from-[#1E928C]/10 via-white/50 to-[#C9A026]/10 rounded-3xl border-2 border-[#1E928C]/30 backdrop-blur-xl shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <h3 className="text-2xl sm:text-3xl font-bold text-[#113649] mb-4">
                Still have questions?
              </h3>
              <p className="text-[#113649]/60 mb-6 sm:mb-8 text-base sm:text-lg max-w-xl mx-auto">
                Our team is here to help. Get in touch and we'll answer all your queries.
              </p>
              <button className="w-full sm:w-auto relative overflow-hidden bg-gradient-to-r from-[#1E928C] to-[#113649] text-white px-10 sm:px-12 py-4 rounded-full font-bold text-base sm:text-lg shadow-2xl hover:shadow-[0_20px_60px_rgba(30,146,140,0.4)] transition-all duration-500 hover:scale-110 group">
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 sm:gap-3 mb-6 sm:mb-8">
            <div className="h-px w-12 sm:w-20 bg-gradient-to-r from-transparent to-[#C9A026]"></div>
            <span className="text-[#C9A026] text-[10px] sm:text-xs font-bold tracking-[0.3em] sm:tracking-[0.4em] uppercase">Let's Connect</span>
            <div className="h-px w-12 sm:w-20 bg-gradient-to-l from-transparent to-[#C9A026]"></div>
          </div>
          
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 sm:mb-8 text-white tracking-tight px-4">
            Ready to Partner With Us?
          </h2>
          <p className="text-lg sm:text-xl md:text-2xl text-white/80 mb-10 sm:mb-14 max-w-3xl mx-auto leading-relaxed font-light px-4">
            Let's create exceptional leather products together. Contact us to discuss your next project.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center px-4">
            <button className="w-full sm:w-auto group relative overflow-hidden bg-gradient-to-r from-[#C9A026] to-[#C9A026] text-white px-10 sm:px-14 py-5 sm:py-6 rounded-full font-bold text-lg sm:text-xl shadow-2xl hover:shadow-[0_20px_80px_rgba(201,160,38,0.5)] transition-all duration-500 hover:scale-110">
            ...
            <button className="w-full sm:w-auto group relative border-2 border-white/40 backdrop-blur-xl bg-white/10 text-white px-10 sm:px-14 py-5 sm:py-6 rounded-full font-bold text-lg sm:text-xl hover:bg-white/20 hover:border-white/60 transition-all duration-500 hover:scale-110 shadow-xl">
              <span className="relative z-10">Schedule Call</span>
            </button>
          </div>
          
          {/* Premium Contact Info - RESPONSIVE */}
          <div className="mt-12 sm:mt-16 flex flex-col sm:flex-row flex-wrap justify-center gap-6 sm:gap-12 text-white/60 text-xs sm:text-sm px-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex gap-3 sm:gap-4">
                <a href="#" className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-white/10 backdrop-blur-xl flex items-center justify-center hover:bg-[#1E928C] transition-all duration-300 cursor-pointer group shadow-lg hover:shadow-xl hover:scale-110">
                  <Facebook className="w-5 h-5 sm:w-6 sm:h-6 text-white/60 group-hover:text-white transition-colors" />
                </a>
                <a href="#" className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-white/10 backdrop-blur-xl flex items-center justify-center hover:bg-[#1E928C] transition-all duration-300 cursor-pointer group shadow-lg hover:shadow-xl hover:scale-110">
                  <Twitter className="w-5 h-5 sm:w-6 sm:h-6 text-white/60 group-hover:text-white transition-colors" />
                </a>
                <a href="#" className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-white/10 backdrop-blur-xl flex items-center justify-center hover:bg-[#C9A026] transition-all duration-300 cursor-pointer group shadow-lg hover:shadow-xl hover:scale-110">
                  <Instagram className="w-5 h-5 sm:w-6 sm:h-6 text-white/60 group-hover:text-white transition-colors" />
                </a>
                <a href="#" className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-white/10 backdrop-blur-xl flex items-center justify-center hover:bg-[#1E928C] transition-all duration-300 cursor-pointer group shadow-lg hover:shadow-xl hover:scale-110">
                  <Linkedin className="w-5 h-5 sm:w-6 sm:h-6 text-white/60 group-hover:text-white transition-colors" />
                </a>
              </div>
            </div>
          ...
          <div className="border-t border-[#1E928C]/20 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-gray-400 text-xs sm:text-sm">
              <p className="text-center md:text-left">Copyright © 2025 RGA Leatherworks. All Rights Reserved.</p>
